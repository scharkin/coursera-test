...
// It inserts a random category into the home HTML snippet and then insert that snippet into our main page (index.html).
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      // STEP 3: Substitute {{randomCategoryShortName}} in the home html snippet with chosenCategoryShortName
      // need to surround the chosen category short name with "'" before inserting it into the home html snippet.
